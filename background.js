...
`;
    ...
    try {
      ...
      if (jsonMatch) {
        ...
        return {
          status: "error",
          explanation: "Couldn't parse Claude's response properly. Raw response was: " + claudeResponse.substring(0, 100) + "..."
        };
      }
    } catch (parseError) {
      ...
      return {
        status: "error", 
        explanation: "Error parsing analysis result. Claude may not have returned a valid response."
      };
    }
  } catch (error) {
